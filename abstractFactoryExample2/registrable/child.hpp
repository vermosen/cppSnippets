...
{
public:
	virtual void foo() { std::cout << "It's alive 2 !" << std::endl; }
private:
...
{
public:
	virtual void foo() { std::cout << "It's alive 3 !" << std::endl; }
private:
...
{
public:
	virtual void foo() { std::cout << "It's alive 4 !" << std::endl; }
private:
...
{
public:
	virtual void foo() { std::cout << "It's alive 5 !" << std::endl; }
private:
