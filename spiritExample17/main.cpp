...
//	qi::rule<iterator, boost::gregorian::date(std::string), qi::locals<std::string>, ascii::space_type > rDate;
//
//	qi::rule<iterator, settings(), ascii::space_type> rSettingsBase;
