...
namespace test
{
    ...
    struct record_parser : qi::grammar<It, std::vector<test::record>(), ascii::blank_type>
    {
        record_parser() : record_parser::base_type(rRecords)
        {
            rString
                %= qi::lexeme[eps > *(qi::char_ - lit("\",\""))];
        ...
        qi::rule<It, std::string(), ascii::blank_type> rString;
        qi::rule<It, boost::optional<double>(), ascii::blank_type> rOptDouble;
        qi::rule<It, record(), ascii::blank_type> rRecord;
        qi::rule<It, std::vector<record>(), ascii::blank_type> rRecords;
...
int main()
{
    ...
    std::cout << "Conversion done in " << boost::chrono::duration_cast<boost::chrono::microseconds> (
