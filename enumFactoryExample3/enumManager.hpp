...
/* 
 * File:   enumManager.hpp
 * Author: vermosen
 *
 * Created on September 16, 2017, 3:01 PM
 */
#pragma once
#ifndef ENUMMANAGER_HPP
#define ENUMMANAGER_HPP
...
template <typename _enum>
class enumFactory : public EnumManager<_enum> {
private:
    enumFactory();  // to prevent instantiation
public:
...
std::ostream& operator << (std::ostream& os, _enum en) {
    return os << enumFactory<_enum>::toString(en);
}
